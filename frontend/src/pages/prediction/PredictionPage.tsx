  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="p-4 bg-[#121212] border-[#333333]">
      ...
      <div className="space-y-4">
        {predictions.map((item) => (
          <Card key={item.id} className="p-5 border-[#333333] hover:border-cyan-500/30 transition">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div className="space-y-2 max-w-2xl">
                ...
                <div className="p-3 bg-[#000000] border border-[#333333] rounded-xl text-xs text-gray-300 flex items-start space-x-2">
              ...
              <div className="flex items-center space-x-6 border-t lg:border-t-0 lg:border-l border-[#333333] pt-4 lg:pt-0 lg:pl-6 shrink-0">
