    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2 bg-cyan-950/400 hover:bg-cyan-400 text-black font-bold text-xs rounded-xl shadow-lg transition flex items-center space-x-2"
        >
            ...
            <div
              ...
              className={`p-4 rounded-xl border cursor-pointer transition ${
                selectedIncident?.id === inc.id
                  ...
                  : 'bg-[#121212] border-[#333333] hover:border-gray-700'
              }`}
            >
              ...
              <div className="mt-3 flex items-center justify-between text-[11px] text-gray-500 pt-2 border-t border-[#333333]">
          ...
          {selectedIncident ? (
            <Card title={`Incident Forensic Record: ${selectedIncident.id}`}>
              <div className="space-y-6">
                <div>
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <select
                      ...
                      className="bg-[#000000] border border-cyan-500/40 text-cyan-400 font-bold rounded-lg px-3 py-1 text-xs focus:outline-none"
                    >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs bg-[#000000] p-4 rounded-xl border border-[#333333]">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedIncident.affectedSystems.map((sys, idx) => (
                      <span key={idx} className="px-3 py-1 bg-[#000000] border border-[#333333] text-xs text-cyan-300 rounded-lg">
                        {sys}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#000000] border border-[#333333] rounded-xl p-3 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500"
                  />
                </div>
              </div>
            </Card>
      ...
      {/* New Incident Modal */}
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#000000]/70 p-4">
          <div className="bg-[#121212] border border-[#333333] w-full max-w-lg rounded-2xl p-6 space-y-4">
            ...
            <form onSubmit={handleCreateIncident} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#000000] border border-[#333333] rounded-xl p-2.5 text-white focus:outline-none focus:border-cyan-500"
                  required
                />
              </div>
              <div>
              ...
              <div className="flex justify-end space-x-3 pt-2">
                <button
                  ...
                  className="px-4 py-2 bg-[#000000] hover:bg-[#2A2A2A] text-gray-300 font-semibold rounded-xl"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2 bg-cyan-950/400 hover:bg-cyan-400 text-black font-bold rounded-xl shadow-lg"
                >
                  Create Incident
                </button>
              </div>
