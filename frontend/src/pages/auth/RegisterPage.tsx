...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#000000] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-cyan-950/400/10 blur-3xl rounded-full pointer-events-none" />

      <div className="max-w-md w-full bg-[#121212] border border-[#333333] rounded-2xl p-8 shadow-2xl space-y-6 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#000000] border border-[#333333] rounded-xl pl-9 pr-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500 transition"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-[#000000] border border-[#333333] text-white rounded-xl p-2.5 focus:outline-none focus:border-cyan-500 font-semibold"
            >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••••••"
                className="w-full bg-[#000000] border border-[#333333] rounded-xl pl-9 pr-9 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500 transition"
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full mt-2 bg-cyan-950/400 hover:bg-cyan-400 text-black font-bold py-3 px-4 rounded-xl text-xs transition shadow-lg shadow-cyan-500/20 flex items-center justify-center space-x-2 disabled:opacity-50"
          >
            {isSubmitting ? (
        ...
        <div className="text-center pt-2 border-t border-[#333333]">
