          ...
          <div className="w-full max-w-lg bg-[#121212] border-l border-[#333333] p-6 h-full overflow-y-auto space-y-6 shadow-2xl">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-[#000000] border border-[#333333] rounded-xl p-4 space-y-3 font-mono">
                  {selectedAnomaly.contributing_features &&
                    Object.entries(selectedAnomaly.contributing_features).map(([key, val]) => (
                      <div key={key} className="flex justify-between border-b border-[#333333] pb-1.5">
