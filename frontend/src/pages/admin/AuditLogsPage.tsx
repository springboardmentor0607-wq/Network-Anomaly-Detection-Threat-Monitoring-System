  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-0 overflow-hidden">
        <div className="p-4 border-b border-[#333333] bg-[#121212] flex items-center justify-between">
              ...
              {filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-[#2A2A2A]">
                  ...
                  <td className="py-3 px-4">
                    <span className="px-2 py-0.5 bg-[#000000] border border-[#333333] text-cyan-300 font-bold rounded text-[10px]">
                      {log.action}
                    </span>
                  </td>
