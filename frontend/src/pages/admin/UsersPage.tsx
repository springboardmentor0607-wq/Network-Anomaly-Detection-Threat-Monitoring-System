    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2 bg-cyan-950/400 hover:bg-cyan-400 text-black font-bold text-xs rounded-xl shadow transition flex items-center space-x-2"
        >
      ...
      <Card className="p-0 overflow-hidden">
        <div className="p-4 border-b border-[#333333] bg-[#121212]">
          <div className="relative max-w-xs">
            ...
            <input
              ...
              className="w-full bg-[#000000] border border-[#333333] rounded-xl pl-9 pr-4 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500"
            />
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-[#333333] bg-[#121212] text-gray-400 font-bold uppercase">
            ...
            <tbody className="divide-y divide-[#1F2937] text-gray-200">
              {filteredUsers.map((u) => (
                <tr key={u.id} className="hover:bg-[#2A2A2A]">
                  ...
                  <td className="py-3 px-4 text-right space-x-2">
                    <button
                      ...
                      className="px-3 py-1 bg-[#000000] hover:bg-[#2A2A2A] border border-[#333333] text-gray-300 text-xs font-semibold rounded"
                    >
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#000000]/70 p-4">
          <div className="bg-[#121212] border border-[#333333] w-full max-w-md rounded-2xl p-6 space-y-4">
            ...
            <form onSubmit={handleAddUser} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end space-x-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-cyan-950/400 hover:bg-cyan-400 text-black font-bold rounded-xl shadow"
                >
                  Add Operator
                </button>
              </div>
