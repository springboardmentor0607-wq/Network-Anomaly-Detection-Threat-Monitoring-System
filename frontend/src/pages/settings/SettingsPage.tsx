  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-2 border-b border-[#333333]">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                  demoMode ? 'bg-cyan-950/400' : 'bg-gray-700'
                }`}
              >
                <span className={`inline-block h-4 w-4 transform rounded-full bg-[#121212] transition ${demoMode ? 'translate-x-6' : 'translate-x-1'}`} />
              </button>
            </div>
            ...
            <div className="py-2 border-b border-[#333333]">
              ...
              <input
                ...
                className="w-full h-2 bg-[#000000] rounded-lg appearance-none cursor-pointer accent-cyan-500"
              />
            </div>
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                  audioAlerts ? 'bg-cyan-950/400' : 'bg-gray-700'
                }`}
              >
                <span className={`inline-block h-4 w-4 transform rounded-full bg-[#121212] transition ${audioAlerts ? 'translate-x-6' : 'translate-x-1'}`} />
              </button>
            </div>
          </div>
        </Card>
          ...
          <div className="space-y-4">
            <div className="py-2 border-b border-[#333333]">
              ...
              <input
                ...
                className="w-full h-2 bg-[#000000] rounded-lg appearance-none cursor-pointer accent-red-500"
              />
          ...
          <div className="space-y-4 text-xs">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#000000] border border-[#333333] rounded-xl px-4 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-cyan-500"
              />
            </div>
            <div>
        ...
        <button
          type="submit"
          className="px-6 py-3 bg-cyan-950/400 hover:bg-cyan-400 text-black font-bold text-xs rounded-xl shadow-lg shadow-cyan-500/20 transition flex items-center space-x-2"
        >
