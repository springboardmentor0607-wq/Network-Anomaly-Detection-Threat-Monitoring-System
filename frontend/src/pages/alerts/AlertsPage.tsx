...
export const AlertsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filter & Search Bar */}
      <Card className="p-4 border-[#333333]">
          ...
          <div className="flex items-center space-x-3 w-full sm:w-auto">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                className="w-full bg-[#000000] border border-[#333333] rounded-xl pl-9 pr-4 py-2 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500"
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs">
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="bg-[#000000] border border-[#333333] text-white rounded-lg px-3 py-1.5 focus:outline-none"
              >
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-[#1F2937] text-gray-200">
              {filteredAlerts.map((alt) => (
                <tr key={alt.id} className="hover:bg-[#2A2A2A] transition">
                  ...
                  <td className="py-3 px-4">
                    <select
                      ...
                      className="bg-[#000000] border border-[#333333] text-gray-300 rounded px-2 py-1 text-xs focus:outline-none"
                    >
                      <option value="NEW">NEW</option>
                      <option value="INVESTIGATING">INVESTIGATING</option>
                      <option value="ESCALATED">ESCALATED</option>
