  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2 p-4 border-[#333333]">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#000000] border border-[#333333] rounded-xl pl-9 pr-4 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500"
            />
          </div>
        </Card>

        <Card className="p-4 border-[#333333] flex items-center justify-around text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredIocs.map((ioc) => (
          <Card key={ioc.ip} className="p-5 border-[#333333] hover:border-cyan-500/30 transition">
            <div className="space-y-4">
              ...
              <div className="p-3 bg-[#000000] border border-[#333333] rounded-xl text-xs space-y-2">
              ...
              <div className="flex items-center justify-between text-xs text-gray-400 pt-2 border-t border-[#333333]">
