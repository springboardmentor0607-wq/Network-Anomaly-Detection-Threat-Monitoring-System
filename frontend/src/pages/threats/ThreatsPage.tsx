...
export const ThreatsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs">
          <div className="flex items-center space-x-3">
            ...
            <select
              ...
              className="bg-[#000000] border border-[#333333] rounded px-2.5 py-1.5 text-cyan-400 font-semibold focus:outline-none"
            >
              <option value="ALL" className="bg-[#121212]">ALL CLASSES</option>
              <option value="DoS" className="bg-[#121212]">DoS / DDoS</option>
              <option value="Brute Force" className="bg-[#121212]">Brute Force</option>
              <option value="BENIGN" className="bg-[#121212]">BENIGN ONLY</option>
            </select>
          </div>
          ...
          <div className="flex items-center space-x-2 text-gray-400">
            ...
            <select
              ...
              className="bg-[#000000] border border-[#333333] rounded px-2.5 py-1 text-cyan-400 font-semibold focus:outline-none"
            >
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-[#1F2937]">
              {isLoading ? (
                ...
                threats.map((item) => (
                  <tr key={item.id} className="hover:bg-[#2A2A2A]/60 transition">
      ...
      {selectedThreat && (
        <div className="fixed inset-0 bg-[#000000]/70 backdrop-blur-sm flex justify-end z-50">
          <div className="w-full max-w-lg bg-[#121212] border-l border-[#333333] p-6 h-full overflow-y-auto space-y-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-[#333333] pb-4">
              ...
              <button
                ...
                className="p-1.5 text-gray-400 hover:text-white rounded-lg hover:bg-[#2A2A2A]"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-4 text-xs">
              <div className="p-4 bg-[#000000] border border-[#333333] rounded-xl space-y-2">
