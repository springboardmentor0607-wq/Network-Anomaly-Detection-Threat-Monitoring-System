...
export const GlobalSearchModal: React.FC<GlobalSearchModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-20 bg-[#000000]/70 backdrop-blur-sm p-4">
      <div className="bg-[#121212] border border-[#333333] w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        {/* Input bar */}
        <div className="relative p-4 border-b border-[#333333] flex items-center">
              ...
              <div className="space-y-1">
                {searchResults.map((res, idx) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-xl bg-[#000000] hover:bg-[#2A2A2A] border border-[#333333] flex items-center justify-between transition group"
                  >
              ...
              <div className="grid grid-cols-2 gap-2">
                {quickLinks.map((item, idx) => (
                  <button
                    ...
                    className="p-3 rounded-xl bg-[#000000] hover:bg-[#2A2A2A] border border-[#333333] flex items-center space-x-3 text-left transition group"
                  >
                    {item.icon}
        ...
        <div className="px-4 py-2.5 bg-[#000000] border-t border-[#333333] flex items-center justify-between text-[11px] text-gray-500">
          <span>Tip: Use <kbd className="px-1.5 py-0.5 bg-[#222222] rounded text-gray-300">Esc</kbd> to close</span>
