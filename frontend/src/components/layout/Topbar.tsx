...
export const Topbar: React.FC<TopbarProps> = ({ title = 'SOC Dashboard Overview' }) => {
  ...
  return (
    <>
      <header className="h-16 bg-[#121212] border-b border-[#333333] px-6 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        {/* Title / Breadcrumbs */}
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="relative hidden md:flex items-center w-64 bg-[#000000] border border-[#333333] hover:border-cyan-500/50 rounded-lg px-3 py-1.5 text-xs text-gray-400 transition"
          >
          ...
          <button
            ...
            className={`p-2 rounded-lg border transition ${
              audioAlerts
                ...
                : 'bg-[#000000] text-gray-400 border-[#333333] hover:text-gray-200'
            }`}
          ...
          <button
            ...
            className="px-3 py-1 bg-[#000000] hover:bg-[#2A2A2A] border border-[#333333] text-xs font-semibold text-gray-300 rounded-lg transition"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-2 p-1.5 text-gray-300 hover:text-white rounded-lg hover:bg-[#2A2A2A] transition"
            >
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-[#121212] border border-[#333333] rounded-xl shadow-2xl py-2 z-50">
        ...
        {toasts.map((toast) => (
          ...
          >
            ...
            <button
              ...
              className="text-gray-400 hover:text-white p-1 rounded hover:bg-[#000000]/30"
            >
              ✕
            </button>
          </div>
