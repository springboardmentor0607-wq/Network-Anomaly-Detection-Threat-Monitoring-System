...
import { SOCManagerDashboard } from './pages/dashboards/SOCManagerDashboard';
import { SecurityAnalystDashboard } from './pages/dashboards/SecurityAnalystDashboard';
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/dashboard/manager" element={<SOCManagerDashboard />} />
                <Route path="/dashboard/analyst" element={<SecurityAnalystDashboard />} />
